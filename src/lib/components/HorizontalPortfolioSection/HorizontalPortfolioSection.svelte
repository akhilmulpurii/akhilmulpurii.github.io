<script lang="ts">
	...
	let filteredProjects = projects.splice(0, 6);
		...
		<div bind:this={horizontalSection} class="horizontal">
			<div class="text-white flex flex-col justify-center items-center w-2/5 p-10">
				<div>
					...
					<h3 class="text-base max-w-[400px]">
